...
import type {IBaseException, IApiErrorResponse} from "./exceptions/baseExceptions.ts";
...
axiosInstance.interceptors.response.use(
    ...
    (error: unknown) => {
        if (axios.isAxiosError(error)) {
            ...
            const backendErrorPayload: IBaseException | undefined = typedError.response?.data?.error;
